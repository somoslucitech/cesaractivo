    ...
    <section id="cesar" className="py-24 sm:py-32">
      <div className="mx-auto grid max-w-5xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          ...
          <p className="mt-1 text-sm font-medium text-texto-medio">
        ...
        <Reveal delay={0.1} className="grid grid-cols-2 gap-3">
          <div>
            ...
            <p className="mt-2 text-center text-sm font-medium text-texto-medio">Antes</p>
          </div>
          <div>
            <div className="relative aspect-[9/20] w-full overflow-hidden rounded-2xl bg-azul-suave shadow-[0_18px_40px_-24px_rgba(0,61,115,0.45)]">
              <Image
            ...
            <p className="mt-2 text-center text-sm font-medium text-azul">Después</p>
          </div>
        </Reveal>
      </div>
    </section>
